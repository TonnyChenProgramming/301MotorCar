...
module ADC_SAR_v3_10_12 (
	...
	cy_clock_v1_0
		#(.id("ce056c6c-d052-4601-8472-cf289c42a28a/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
...
module top ;
	...
	wire [0:0] tmpOE__VDAC_output_net;
	wire [0:0] tmpFB_0__VDAC_output_net;
	wire [0:0] tmpIO_0__VDAC_output_net;
	wire [0:0] tmpINTERRUPT_0__VDAC_output_net;
	electrical [0:0] tmpSIOVREF__VDAC_output_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		VDAC_output
		 (.oe(tmpOE__VDAC_output_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__VDAC_output_net[0:0]}),
		  .analog({Net_4355}),
		  .io({tmpIO_0__VDAC_output_net[0:0]}),
		  .siovref(tmpSIOVREF__VDAC_output_net),
		  .interrupt({tmpINTERRUPT_0__VDAC_output_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__VDAC_output_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    ADC_SAR_v3_10_12 ADC_SAR_1 (
        .aclk(1'b0),
        .eoc(Net_4360),
        .eos(Net_4363),
        .soc(Net_1619),
	...
	wire [0:0] tmpOE__V_ADC_in_net;
	wire [0:0] tmpFB_0__V_ADC_in_net;
	wire [0:0] tmpIO_0__V_ADC_in_net;
	wire [0:0] tmpINTERRUPT_0__V_ADC_in_net;
	electrical [0:0] tmpSIOVREF__V_ADC_in_net;

	cy_psoc3_pins_v1_10
		#(.id("3aff81dc-dfea-4fcd-9d97-eeef132cf20b"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		V_ADC_in
		 (.oe(tmpOE__V_ADC_in_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__V_ADC_in_net[0:0]}),
		  .analog({Net_4357}),
		  .io({tmpIO_0__V_ADC_in_net[0:0]}),
		  .siovref(tmpSIOVREF__V_ADC_in_net),
		  .interrupt({tmpINTERRUPT_0__V_ADC_in_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__V_ADC_in_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__OUT1_net;
	wire [0:0] tmpIO_0__OUT1_net;
	wire [0:0] tmpINTERRUPT_0__OUT1_net;
	electrical [0:0] tmpSIOVREF__OUT1_net;

	cy_psoc3_pins_v1_10
		#(.id("717d7794-57b2-4b0e-a5e5-9a8bd34c0d89"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		OUT1
		 (.oe(tmpOE__OUT1_net),
		  .y({1'b0}),
		  .fb({Net_4368}),
		  .io({tmpIO_0__OUT1_net[0:0]}),
		  .siovref(tmpSIOVREF__OUT1_net),
		  .interrupt({tmpINTERRUPT_0__OUT1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__OUT1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
