...
#define BS_IOPINS0_0_VAL ((const uint8 CYFAR *)0x48000B3Cu)

/* IOPINS0_7 Address: CYREG_PRT12_DM0 Size (bytes): 8 */
#define BS_IOPINS0_7_VAL ((const uint8 CYFAR *)0x48000B44u)
...
#define BS_IOPINS0_3_VAL ((const uint8 CYFAR *)0x48000B6Cu)
...
static void ClockSetup(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)(CYREG_CLKDIST_DCFG3_CFG0), 0x01ACu);
