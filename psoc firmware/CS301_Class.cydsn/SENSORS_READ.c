...
MovementState GetMovement(void) {
    ...
    switch(sensors) {
        case 0b000110: return STRAIGHT;
        case 0b000111: return LEFT_TURN;
        case 0b001110: return RIGHT_TURN;
        case 0b100110: return DRIFTED_RIGHT;
        case 0b010110: return DRIFTED_LEFT;
